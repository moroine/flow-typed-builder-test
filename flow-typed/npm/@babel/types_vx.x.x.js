...
declare module "@babel/types" {
   ...
   */
  declare export type SpreadProperty = SpreadElement;
  ...
  declare export type Pattern =
    ...
    | ArrayPattern
    | ObjectPattern;
  declare export type Class = ClassExpression | ClassDeclaration;
  ...
  >(
    node: Extract<
      Node,
      { [key: K]: BlockStatement | Statement | Expression, ... }
    >,
    key: K
  ): BlockStatement;
  ...
  declare export function valueToNode(
    value: $ReadOnlyArray<
      void | boolean | null | string | number | RegExp | { [key: string]: any }
    >
  ): ArrayExpression;
  ...
  >(
    member: T,
    prepend: $PropertyType<MemberExpression, "object">
  ): T;
  ...
  declare export function getBindingIdentifiers(
    ...
    duplicates: boolean,
    outerOnly?: boolean
  ): { [key: string]: Identifier | Array<Identifier>, ... };
  ...
  declare export function shallowEqual<T: { [key: string]: any }>(
  ...
  declare export function isPlaceholderType(
    ...
    targetType: $PropertyType<Node, "type">
  ): boolean;
  ...
  declare export function isType<T: $PropertyType<Node, "type">>(
    nodetype: string,
    targetType: T
  ): boolean;
